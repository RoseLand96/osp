...
?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Agregar supervisor</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$id=$_GET['numero_identif'];
   $query="SELECT * from supervisor where numero_identif='$id'";
$resultado=$conexion->query($query);
$row=$resultado->fetch_assoc();
?>
                                    <form role="form" action="proceso_modificar_supervisor.php?numero_identif=<?php echo $row['numero_identif'];?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nombre<FONT color="red">*</FONT></label>
                                            <input type="text" class="form-control" id="inputError" REQUIRED  name="txtnombre" value="<?php echo $row['nombre_sup'];?>">
                                            <br>
                                            <br>
                                            <label>Apellido paterno<FONT color="red">*</FONT></label>
                                             <input type="text" class="form-control" id="inputError" REQUIRED name="txtappat" value="<?php echo $row['apellido_pat'];?>">

                                             <br>
                                             <br>
                                               
                                          <label>Apellido materno<FONT color="red">*</FONT></label>
                                             <input type="text" class="form-control" id="inputError" REQUIRED name="txtapmat" value="<?php echo $row['apellido_mat'];?>">

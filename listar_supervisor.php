...
?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listar supervisores</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
    <div class="row">
  ...
  <div class="modal-content">
    ...
    <form role="form" action="insertar_supervisor.php" method="POST" enctype="multipart/form-data">
...
function(){
   window.location.href = "eliminar_supervisor.php?numero_identif=<?php echo $row['numero_identif']; ?>"; 
   swal("Suprimido!", "El registro ha sido suprimido.", "success");  
        ...
        break;
                                    ...
                                    <tr>
                                     ...
                                     <th class="center"><a href="modificar_supervisor.php?numero_identif=<?php echo $row['numero_identif']; ?>" ><img src="image/modif.png"></a></th>

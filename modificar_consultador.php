...
<head>
    ...
    <title>Modificar Consultador</title>
...
?>
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>Administación</a>
                        </li>
                         <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Modificar consultador</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$id=$_GET['id_cons'];
$query="SELECT * from consultador_rep where id_cons='$id'";
$resultado=$conexion->query($query);
$row=$resultado->fetch_assoc();

   ?>
                                    <form role="form" action="proceso_modificar_consultador.php?id_cons=<?php echo $row['id_cons'];?>" method="POST" enctype="multipart/form-data">
